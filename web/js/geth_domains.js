const geth_domains_address = "0x808f8C0ef316912Bb310fd21c648774eb48CE4f3";
...
let domains_pointer_overwritten_event_emitter = null;
async function _initDomainsEvents() {
    ...
    [
		...
		domains_pointer_overwritten_event_emitter,
    ...
    // Subscribe to DomainPointerEdited events
    ...
    domains_pointer_overwritten_event_emitter = contract.events.DomainPointerEdited().on('data', _onOverwrittenEvent).on('error', _onError);
}
