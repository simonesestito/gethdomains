...
class DomainSearchErrorBanner extends StatelessWidget {
  ...
  Widget _buildErrorBanner(BuildContext context, DomainSearchStateError error) => BannerCard(
        content: Text(AppLocalizations.of(context)!.domainSearchResultError),
        color: Colors.red.shade700,
        icon: const Icon(Icons.error),
      );

  Widget _buildSuccessBanner(BuildContext context, DomainSearchStateSuccess success) => BannerCard(
        content: Text(AppLocalizations.of(context)!.domainSearchResultSuccess(
